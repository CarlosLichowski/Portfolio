  ...
  return (
    <>
      ...
      <div className="AppContainer">
        ...
        <AnimateOnView animationProps={{ initial: { opacity: 0, y: 75 }, animate: { opacity: 1, y: 0 }, transition: { duration: 0.5, delay: 0.45 } }}>
          <div className="section"><Banner /></div>
        </AnimateOnView>
        <AnimateOnView animationProps={{ initial: { opacity: 0, scale: 0.8 }, animate: { opacity: 1, scale: 1 }, transition: { duration: 0.4, delay: 0.45 } }}>
